...
@ManagedBean(name = "boletimProfessorMB")
@SessionScoped
public class BoletimProfessorMB implements Serializable {
	...
	public List<Curso> localizaCursos(Acesso acesso) {
	System.out.println("Inicializando:"+acesso.getIdentificacao());
	selecaoProfessor=Integer.parseInt(acesso.getIdentificacao());
    setListaCursos(pdtDao.listaCursos(selecaoProfessor, selecaoAno, selecaoSemestre));
	return listaCursos;
	}

	// Listando as turmas do curso selecionado
	public void listaTurmaCurso() {
        setListaTurmas(pdtDao.localizaTurmaCurso(selecaoCurso, selecaoProfessor, selecaoAno, selecaoSemestre));
	...
	public void listaTurmaModulo() {
		setListaTurmas(pdtDao.localizaTurmaModulo(selecaoCurso, selecaoProfessor, selecaoAno, selecaoModulo, selecaoSemestre));
		listaDisciplina();
		atualizaAulasDadas();
	...
	public void listaDisciplina() {
		setListaDisciplinas(pdtDao.listaDisciplinas(selecaoCurso, selecaoAno, selecaoSemestre, selecaoModulo, selecaoProfessor));
	...
	public String redirecionar() {
		...
		return "./insereBoletimProfessor.jsf";
	}
	...
	public String inserir() {
		...
		if (inserido) {
			context.addMessage("formInsereBoletimProfessor:mensagem", new FacesMessage(
					FacesMessage.SEVERITY_INFO, "Dados inseridos com sucesso",
					"" + ""));
		} else {
			context.addMessage(
					"formInsereBoletimProfessor:mensagem",
					new FacesMessage(
	...
	public String modificarDados() {
		...
		boletimCadastrado.setStatus("");
		desabilitaNovaSelecaoNota=true;
		return "./modificarBoletimProfessor.jsf";
	...
	public String inserirDadoUnico() {
		...
		if((!novoCadastroNota.equalsIgnoreCase("") && !novoCadastroNota.equalsIgnoreCase(null))
			...
			if (inserido) {
				context.addMessage("formModificaDadosBoletimProfessor:mensagem", new FacesMessage(
						FacesMessage.SEVERITY_INFO, "Dados inseridos com sucesso",
						"" + ""));
				limpaCampo();
				desabilitaNovaSelecaoNota=true;
